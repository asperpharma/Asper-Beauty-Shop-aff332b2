...
const WEBHOOK_URL = process.env.WEBHOOK_URL ||
  "http://localhost:54321/functions/v1/datadog-webhook";
const WEBHOOK_SECRET = process.env.DATADOG_WEBHOOK_SECRET ||
...
async function main() {
  ...
  console.log(
    `\nOverall: ${
      validTest && invalidTest ? "ALL TESTS PASSED ✓" : "SOME TESTS FAILED ✗"
    }`,
  );
